...
int main(int argc, char* argv[])
{
  ...
  std::string fs = Path::fileSpec(".","Log.txt");
  std::cout << "\n  Path::fileSpec(\".\",\"Log.txt\") = " << fs;
  ...
  std::string upper = Path::toUpper("Log.txt");
  std::cout << "\n  Path::toUpper(\"Log.txt\") = " << upper;

  std::string lower = Path::toLower("Log.Txt");
  std::cout << "\n  Path::toLower(\"Log.Txt\") = " << lower;
  std::cout << std::endl;
  /*
